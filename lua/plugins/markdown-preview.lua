...
local M = {}
M[1] = {}
local markdown_preview = M[1]


markdown_preview[1] = 'iamcco/markdown-preview.nvim'
markdown_preview.event = 'FileType'


markdown_preview.build = function ()
    -- 跨平台构建命令，带错误处理
...
markdown_preview.cmd = { "MarkdownPreviewToggle", "MarkdownPreview", "MarkdownPreviewStop" }


markdown_preview.ft = { "markdown" }


markdown_preview.keys = { -- 添加实用的快捷键
    { "<leader>mp", "<cmd>MarkdownPreviewToggle<CR>", desc = "Markdown 预览" },
    { "<leader>ms", "<cmd>MarkdownPreviewStop<CR>", desc = "停止预览" },
}


markdown_preview.init = function ()
    -- 设置文件类型检测
...
markdown_preview.config = function ()
    -- 添加语法高亮支持
