" begin 分屏设置
nnoremap sh :set nosplitright<CR>:vsplit<CR>	" 左分屏
nnoremap sl :set splitright<CR>:vsplit<CR>	" 右分屏
nnoremap sk :set nosplitbelow<CR>:split<CR>	" 上分屏
nnoremap sj :set splitbelow<CR>:split<CR>	" 下分屏
...
nnoremap <C-A-Left> :wincmd H<CR>			" 将当前分屏移至最左
nnoremap <C-A-Right> :wincmd L<CR>		" 将当前分屏移至最右
nnoremap <C-A-Up> :wincmd K<CR>			" 将当前分屏移至最上
nnoremap <C-A-Down> :wincmd J<CR>			" 将当前分屏移至最
" end 分屏设置
