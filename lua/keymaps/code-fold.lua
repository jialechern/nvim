...
-- open fold
map_by_modes({ 'n', 'x' }, get_key('open'), 'zo', {  desc = "打开当前光标所在的代码折叠" })
-- delect fold
map_by_modes({ 'n', 'x' }, get_key('delect'), 'zd', {  desc = "删除当前光标所在的代码折叠" })
-- fold
map_by_modes({ 'n', 'x' }, get_key('fold'), 'zf', {  desc = "折叠当前光标所在的代码" })
-- expansion 展开所有折叠
